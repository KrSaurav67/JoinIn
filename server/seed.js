...
const users = [
    { name: 'Admin User', email: 'admin@joinin.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@joinin.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@joinin.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@joinin.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@joinin.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@joinin.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@joinin.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@joinin.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@joinin.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@joinin.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@joinin.com');
        console.log('User Email:  user@joinin.com');
