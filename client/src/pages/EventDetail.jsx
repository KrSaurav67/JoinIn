...
const EventDetail = () => {
    ...
    // const backpaystatus = params.get("backshowotp");
    ...
    const handleBooking = async () => {
        ...
        try {
            ...
            if (!showOTP) {
                ...
                //     setpaystatus(true);
                //     window.open(`/events/${id}/payment-page`, "_blank");
                ...
                <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-6">
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 min-w-[300px] w-full md:w-auto shrink-0 shadow-sm">
                        ...
                        {/* {event && ((new Date())>(new Date(event.date))) && (
                            <div className={`w-full py-4 px-6 rounded-xl font-bold text-lg transition shadow-lg
                                 bg-gray-900 hover:bg-black text-white cursor-not-allowed flex items-center justify-center
                                `}>
                                    Event Expired
                        ...
                        {(bookingstatus === null || bookingstatus === "cancelled") && !((new Date())>(new Date(event.date))) && (
                        <button
                        ...
                        {event && new Date() > new Date(event.date) ? (
                            ...
                            <div className="w-full py-4 px-6 rounded-xl font-bold text-lg transition shadow-lg
                                            bg-gray-900 hover:bg-black text-white cursor-not-allowed flex flex-col items-center justify-center">
                                Booking request submitted
                            </div>
                            ) : (
                            <button
                                onClick={handleBooking}
                                disabled={isSoldOut || bookingLoading || (showOTP && !otp && !paystatus) || paystatus}
